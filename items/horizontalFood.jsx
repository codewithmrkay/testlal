    ...
    >
      ...
      >
        {cards.map((card) => (
          <div
            key={card.id}
            className="overflow-hidden h-[400px] w-[200px] lg:h-[300px] lg:w-[500px] bg-cover bg-center rounded-[18px] text-[#f6f2e8]  text-3xl font-bold  bg-gray-900 cursor-pointer"
          >
            <img
              className="w-full h-full object-cover object-center opacity-50 transform transition-all duration-500 ease-in-out hover:opacity-100 hover:scale-115 lg:hover:-translate-x-[35px] hover:object-cover"
              src={card.img}
              alt={card.title}
            />
